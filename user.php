...
<section id="container">
	<div class="wrap-container">
		...
		<section class="content-box box-3 box-style-1"><!--Start Box-->
			<div class="zerogrid">
				<div class="row">
					<h2 class="header t-center">User Login</h2>
					<div class="row">
						<div class="col-1-12">
                                                    <form name="form1" id="ff" method="post" action="userlogin">
													<label class="row">
														<div class="col-1-2">
															<div class="wrap-col">
																Username:
													...
													<center><input class="sendButton" type="submit" name="login" value="LOGIN"></center>
												</form>
                                                    <a href="reguser">Register User</a><br><br><br>
						</div>
